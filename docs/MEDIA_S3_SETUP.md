...
1. В панели Timeweb Cloud создайте **объектное хранилище S3** и бакет, получите **Access Key** и **Secret Key**, узнайте **Endpoint URL** (например `https://s3.timeweb.cloud`).
